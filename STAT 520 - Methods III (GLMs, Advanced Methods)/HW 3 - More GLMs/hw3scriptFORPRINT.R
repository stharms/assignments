...
#then for females
plot(log(bmmSD)~log(bmmMean), pch = 19, cex = 1.5, xlab = "Log of Group Mean", ylab = "Log of Group SD",main="Male")
...
plot(log(bmfSD)~log(bmfMean), pch = 19, cex = 1.5, xlab = "Log of Group Mean", ylab = "Log of Group SD",main="Female")
...
#Now, choose covariates for our model
...
#########  Construct 95% Wald intervals for regression parameters
